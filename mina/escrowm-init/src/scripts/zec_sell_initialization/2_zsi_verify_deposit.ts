...
/**
 * Scenario 2 - ZEC Sell Initialization: Verify Deposit
 *
...
async function main() {
  logHeader('Scenario 2: ZEC Sell - Step 2: Verify Deposit');
  ...
  try {
    ...
    if (!trade.isSome.toBoolean()) {
      ...
      console.log('  Run: node build/src/scripts/zec_sell_initialization/3_zsi_lock.js');
